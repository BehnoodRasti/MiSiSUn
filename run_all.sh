...
# SUnS
python unmixing.py hsi=sim1 noise=20dB model=SUnShrink model.T=10000 model.TA=5 model.TB=5 model.mu1=50.0 model.mu2=2.0 model.mu3=1.0 model.hard=False model.lambd=0.01 noise.seed=0,1,2,3,4 --multirun
# MiSiSUn
